...
from core.libs.exceptions import GError
from core.apis.auth import common_auth_resources
from werkzeug.exceptions import HTTPException

from sqlalchemy.exc import IntegrityError


app.register_blueprint(common_auth_resources, url_prefix='/common/auth')
